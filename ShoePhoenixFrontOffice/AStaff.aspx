...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtFirstName" runat="server" style="z-index: 1; left: 224px; top: 383px; position: absolute"></asp:TextBox>
        ...
        <asp:TextBox ID="txtAddress1" runat="server" style="z-index: 1; left: 219px; top: 771px; position: absolute; width: 244px; right: 1086px;"></asp:TextBox>
