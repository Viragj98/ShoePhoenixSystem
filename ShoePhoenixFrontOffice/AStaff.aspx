...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblLastName" runat="server" style="z-index: 1; left: 615px; top: 280px; position: absolute" Text="Last Name"></asp:Label>
        ...
        <asp:Label ID="lblAddress2" runat="server" style="z-index: 1; left: 617px; top: 629px; position: absolute" Text="Address 2"></asp:Label>
